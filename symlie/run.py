...
def parse_options(notebook = False):
    ...
    parser.add_argument("--transform_type", type=str, default='none', help="Type of the transformation")
    parser.add_argument("--linearmodules", nargs='+', default=['MyLinear', 'nn.Linear'], help="Linearmodules")
    ...
    parser.add_argument("--n_splits", nargs='+', default=[400,-1,-1], help="Train, val, test split")

    parser.add_argument("--dim", type=int, default=28, help="Dimension of the image")
...
def main(args):
    ...
    if args.name is None:
        ...
        args.name = f'symlie_data{data_dir}_net{args.net}_transform{args.transform_type}_seed{args.seed}'
