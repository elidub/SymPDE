...
def savefig(fig: plt.figure, name: str, subdir: str = '', format = 'png', path: str = '/Users/elias/EliasMBA/Projects/Uni/Thesis/ai_thesis/figures/code', tight_layout = True,bbox_inches='tight', **kwargs):
    """
    ...
    fig.savefig(os.path.join(path, subdir, f'{name}.{format}'), bbox_inches=bbox_inches, **kwargs)