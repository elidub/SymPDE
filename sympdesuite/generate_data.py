...
from sympdesuite.utils import save_obj
from sympdesuite.solve import SolvePDE
...
def parse_options(notebook = False):
    ...
    parser.add_argument("--data_dir", type=str, default="data/examples/", help="Path to data directory")
